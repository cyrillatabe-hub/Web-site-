...
(function () {
  ...
  function rendrePanier() {
    ...
    if (!panier.length) {
      conteneur.innerHTML = `<div class="panier-vide">${ICONE_PANIER_VIDE}<p>Votre sélection de pâtisserie est vide.</p><a href="menu.html" class="btn btn-outline btn-sm" style="color:#5c376a;border-color:rgba(107,63,160,0.35);">Découvrir la carte</a></div>`;
    } else {
